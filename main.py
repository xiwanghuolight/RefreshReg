...
from models import architectures, RefreshReg
from utils.process import load_config, setup_seed
...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/threedmatch.yaml', help='Path to the config file.')
